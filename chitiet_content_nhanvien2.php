...
<?php
   ...
   }else
   {
    ...
    switch ($rad_name) {
      case 1 :
            include("rad_nhanvien_xh_name1.php");
            break;
      case 2 :
            include("rad_nhanvien_xh_name2.php");   ;
            break;
      case 3 :
            include("rad_nhanvien_xh_name3.php");   ;
            break;
      case 4 :
            include("rad_nhanvien_xh_name4.php");   ;
            break;
      default :
            include("rad_nhanvien_xh_name5.php");
   }
