...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KÊ THEO NV NHẬN HÌNH - ĐẶT CỌC</H1>
            <p style="padding: 0px; margin: 0px;">Từ ngày:&nbsp;<?php echo $_GET['tungay']; ?>&nbsp;&nbsp; Đến ngày:&nbsp;<?php echo $_GET['denngay'];?></p>
    </center>
<h3 style="padding: 0px; margin: 0px 0px 5px;">Nhân viên:<?php echo $namekhach;?></h3>
<table cellspacing="1" cellpadding="1" id="mainTable" style="width: 100%">
 <?php
            ...
            if($toal_nhanvien >0)
            {
              $tongsotienthongke_datcoc_all=0;
...
<tbody>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and nhanvien_quay_id='".$id_nhanvien."' and thanhtoan_id=8 and status=1","id desc ");
    ...
    <tr class="cell1">
      ...
      ?>
       <tr class="cell2">
        <td colspan="2">Tổng tiền đặt cọc</td>
        ...
        <td style="text-align: left; color: red;font-size:14px;"><b><?php echo $utl->format($tongsotienthongke-$tongsotienthongke_datcoc)?> VNĐ</b></td>
    ...
    ?>
     <tr class="cell2">
        ...
        <td style="text-align: left; color: red;font-size:14px;"><b><?php echo $utl->format($tongsotienthongke_datcoc_all)?> VNĐ</b></td>
     </tr>
    <?php
            }// end if nhan vien
    ?>
