...
<tbody>
    <tr class="cell1">
        <td colspan="7"><h2>NV Xuất Hình:<i><?php echo $title_nhanvien ?></i></h2></td>
    </tr>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and nhanvien_id='".$id_nhanvien."' and status=1","id desc ");
