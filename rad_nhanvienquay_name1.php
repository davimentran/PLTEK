...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KÊ THEO NV NHẬN HÌNH - HÓA ĐƠN</H1>
            <p style="padding: 0px; margin: 0px;">Từ ngày:&nbsp;<?php echo $_GET['tungay']; ?>&nbsp;&nbsp; Đến ngày:&nbsp;<?php echo $_GET['denngay'];?></p>
    </center>
<h3 style="padding: 0px; margin: 0px 0px 5px;">Nhân viên nhận hình:<?php echo $namenv;?></h3>
...
<tbody>
    <tr class="cell1">
        <td colspan="7"><h2>NV Nhận Hình:<i><?php echo $title_nhanvien ?></i></h2></td>
    </tr>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and nhanvien_quay_id='".$id_nhanvien."' and status=1","id desc ");
    ...
    <?php
     ...
     ?>
       <tr class="cell2">
        <td colspan="5" style="text-align: right"> TÔNG CỘNG:</td>
