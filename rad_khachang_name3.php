...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KÊ THEO KHÁCH HÀNG - CÔNG NỢ</H1>
...
<tbody>
    <tr class="cell1">
        <td colspan="9"><h2>KH:<i><?php echo $title_khachhang ?></i></h2></td>
    </tr>
    ...
    <?php
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and khachang_id='".$id_khachhang."' and thanhtoan_id!=5 and status=1","id desc ");
