...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KÊ THEO KHÁCH HÀNG - ĐẶT CỌC</H1>
...
<tbody>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and khachang_id='".$id_khachhang."' and thanhtoan_id=8 and status=1","id desc ");
