...
<tbody>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","((datecreated >= ".$tungay." and datecreated <= ".$denngay.") or (dateupdated >= ".$tungay." and dateupdated <= ".$denngay.")) and nhanvien_quay_id='".$id_nhanvien."' and (thanhtoan_id=8  or thanhtoan_id=5) and status=1","id desc ");
