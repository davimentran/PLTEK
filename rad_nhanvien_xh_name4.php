...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KÊ THEO NV XUẤT HÌNH - ĐẶT CỌC</H1>
...
<tbody>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and nhanvien_id='".$id_nhanvien."' and thanhtoan_id=8 and status=1","id desc ");
