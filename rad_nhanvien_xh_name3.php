...
<h3 style="padding: 0px; margin: 0px 0px 5px;">Nhân viên xuất hình:<?php echo $namenv;?></h3>
...
<tbody>
    <tr class="cell1">
        <td colspan="9"><h2>NV Xuất Hình:<i><?php echo $title_nhanvien ?></i></h2></td>
    </tr>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and nhanvien_id='".$id_nhanvien."' and thanhtoan_id!=5 and status=1","id desc ");
