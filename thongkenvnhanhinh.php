...
<div class="panelAction" id="panelAction" style="height: 400px;">
   ...
   <div style="float: left; text-align: left; margin-top: 10px;">
       ...
       <legend style="color: #000080; padding-bottom: 10px"><b>Thống kê theo NV nhận hình</b></legend>
       <span style="float: left; width:100px">NV nhận hình</span>
    <select name="nhanvien_id" id="nhanvien_id" style="width:180px;" onchange="chonnhanvien(this.value)">
  	<option value="">-- Tất cả -- </option>
      <?php
            $rst_nhanvien=$dbf->getDynamic("nhanvien","is_nvquay =1 and status=1","title asc");
...
$('#cmdSearch').click(function (){
    ...
    openBox('chitiet_content_nhanvien.php?tungay='+tungay+'&denngay='+denngay+'&nhanvien_id='+nhanvien_id+'&rad_name='+rad_name+'',792,650);
});
/*]]>*/
</script>