...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KÊ THEO NV NHẬN HÌNH - CÔNG NỢ</H1>
...
<tbody>
    <tr class="cell1">
        <td colspan="9"><h2>NV Nhận Hình:<i><?php echo $title_nhanvien ?></i></h2></td>
    </tr>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and nhanvien_quay_id='".$id_nhanvien."' and thanhtoan_id!=5 and status=1","id desc ");
