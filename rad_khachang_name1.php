...
<div class="panelView" id="panelView">
    ...
    <center>
            <H1>THỐNG KÊ THEO KHÁCH HÀNG - HÓA ĐƠN</H1>
...
<tbody>
    <tr class="cell1">
        <td colspan="7"><h2>KH:<i><?php echo $title_khachhang ?></i></h2></td>
    </tr>
    ...
    <?php
        ...
        $rs_hoadon=$dbf->getDynamic("hoadon","datecreated >= ".$tungay." and datecreated <= ".$denngay." and khachang_id='".$id_khachhang."' and status=1","id desc ");
